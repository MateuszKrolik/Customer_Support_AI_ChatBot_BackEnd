...
export class FastapiAwsRagStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const queryTable = new Table(this, 'QueryTable', {
            ...
            timeToLiveAttribute: "time_to_live_unix_timestamp",
        });

        // enable querying by user_id and descending created_at_unix_timestamp
        queryTable.addGlobalSecondaryIndex({
            indexName: 'queries_by_user_id',
            partitionKey: {name: 'user_id', type: AttributeType.STRING},
            sortKey: {name: 'created_at_unix_timestamp', type: AttributeType.NUMBER}
        });
        ...
        const apiFunction = new DockerImageFunction(this, 'ApiFunc', {
            ...
            environment: {
                DYNAMODB_TABLE_NAME: queryTable.tableName,
            },
        });
